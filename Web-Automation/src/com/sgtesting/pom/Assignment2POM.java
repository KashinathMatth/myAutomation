...
public class Assignment2POM {
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateuserFirstname().sendKeys("Bahubali");
			oPage.getCreateUserLastName().sendKeys("Amarendra");
			Thread.sleep(2000);
			oPage.getCreateUserEmail().sendKeys("bahu@gmail.com");
			oPage.getCreateUsername().sendKeys("kashinathh");
