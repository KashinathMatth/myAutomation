	...
	public static void main(String[] args) 
		...
		static void createUser()
		{
			try
			{
				...
				oPage.getCreateuserFirstname().sendKeys("sudeep");
				oPage.getCreateUserLastName().sendKeys("kiccha");
				oPage.getCreateUserEmail().sendKeys("sudeep@gmail.com");
				Thread.sleep(2000);
				oPage.getCreateUsername().sendKeys("sudeep");
		...
		static void createUser2()
		{
			try
			{
				oPage.getCreateUser().click();
				oPage.getAddUser().click();
				oPage.getCreateuserFirstname().sendKeys("sudeep2");
				oPage.getCreateUserLastName().sendKeys("kiccha2");
				oPage.getCreateUserEmail().sendKeys("sudeep2@gmail.com");
				Thread.sleep(2000);
				oPage.getCreateUsername().sendKeys("sudeep2");
		...
		static void createUser3()
		{
			try
			{
				oPage.getCreateUser().click();
				oPage.getAddUser().click();
				oPage.getCreateuserFirstname().sendKeys("sudeep3");
				oPage.getCreateUserLastName().sendKeys("kiccha3");
				oPage.getCreateUserEmail().sendKeys("sudeep3@gmail.com");
				Thread.sleep(2000);
				oPage.getCreateUsername().sendKeys("sudeep3");
		...
		static void loginasUser1()
		{
			...
			{
				Thread.sleep(2000);
				oPage.getUserName().sendKeys("sudeep");
		...
		static void loginasUser2()
		{
			...
			{
				Thread.sleep(2000);
				oPage.getUserName().sendKeys("sudeep2");
		...
		static void loginasUser3()
		{
			...
			{
				Thread.sleep(2000);
				oPage.getUserName().sendKeys("sudeep3");
