...
public class Assignment6POM {
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getGiveCustomername().sendKeys("Devil");
			Thread.sleep(1000);
	...
	static void createProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.getGiveProjectnameonnameField().sendKeys("Google Theme Editing");
			Thread.sleep(1000);
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getgiveDescriptioninproject().sendKeys("Colour Changes");
			Thread.sleep(1000);
			oPage.getclickSettingstoModifyproject().click();
			Thread.sleep(1000);
		}catch(Exception e)
