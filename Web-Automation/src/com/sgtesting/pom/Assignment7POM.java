...
public class Assignment7POM {
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getGiveCustomername().sendKeys("Abhinaya");
			Thread.sleep(1000);
	...
	static void createProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.getGiveProjectnameonnameField().sendKeys("Instagram Reels Edits");
			Thread.sleep(1000);
	...
	static void createTask()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getselectCreatnewTask1underTask().sendKeys("Scaling The Reels at Free Hand");
			Thread.sleep(1000);
